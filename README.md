...
Realtime-Hybrid-Wildlife-Tracking-on-Edge-Networks
Public
Adarsh-Saurabh/Realtime-Hybrid-Wildlife-Tracking-on-Edge-Networks
Go to file
t
Name		
Adarsh-Saurabh
...
first Push
2 weeks ago
Wildlife_Tracking0.pptx
Add files via upload
last week
Wildlife_Tracking_Project_Report.docx
Add files via upload
last week
Wildlife_Tracking_Report.pdf
Add files via upload
last week
...
Maintain identity when animals temporarily disappear behind vegetation
Handle multiple animals without mixing up their identities
Work efficiently for field deployment scenarios
✨ Key Features
Feature	Description
...
Usage
Data Preparation: Configure paths to your dataset
Export to YOLO Format: Convert annotations to YOLO format
Train YOLOv8: Fine-tune YOLOv8n on your wildlife dataset
Run Tracking: Apply the hybrid tracking pipeline
# Key configuration
...
📋 Deliverables
✅ Working Implementation - Video processing and animal tracking
✅ Visualizations - Tracked animals with trajectories overlaid on video
✅ Presentation - Project slides explaining the approach
✅ Metrics - Tracking accuracy and stability measurements
🎯 Applications
